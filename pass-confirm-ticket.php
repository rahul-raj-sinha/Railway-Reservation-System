                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><span class="badge badge-pill badge-success">Rs.<?php echo $row->pass_train_fare;?></span></td>
                        <td class="center"><span class="badge badge-success"><?php echo $row->pass_fare_payment_code;?></span></td>
                        <td class="center"><a href="pass-confirm-checkout-ticket.php?pass_id = <?php echo $row->pass_id;?>" class="badge badge-success">Confirm Checkout</a></td>
                      </tr>
                        <?php }?>
                    </tbody>
                  </table>
